...
- [ ] Replace the expanded default VPS management workbench with a compact Liquid Glass style fleet status bar and an explicit expand/collapse details panel.
- [ ] Merge the separate operations queue into the workbench details so daily insights occupy one coherent, collapsible surface.
