...
- [ ] Refactor `Fleet3DScene` into a stable Three.js runtime: initialize renderer/camera/controls once, update scene objects through refs, prevent camera resets, and add OrbitControls drag/zoom/pan support.
